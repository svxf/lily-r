...
void cat::utils::log::debug_log(const std::uint64_t address, const char* name)
{
...
std::vector<std::filesystem::path> cat::utils::log::get_roblox_file_logs()
{
...
std::filesystem::path cat::utils::log::get_latest_log()
{
